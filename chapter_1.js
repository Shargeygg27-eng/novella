window.CHAPTER_1 = {
    ...
    // Телефон оставлен на столе
    "ch2_phone_check": {
        bg: "bg_room_night.webp",
        spriteLeft: "", spriteCenter: "zhanna_norm.webp", spriteRight: "",
        speaker: "Жанна",
        text: "(Мысли) Он пошел в ванную, а телефон оставил на столе... Экран загорелся. Одно новое уведомление.",
        choices: [
            { text: "[Прочитать уведомление]", next: "ch3_confrontation_start" },
            { text: "[Отвернуться от телефона]", next: "ch3_trust_path" }
        ]
    },
    ...
    // ВЕТКА 1: Жанна прочитала СМС
    "ch3_confrontation_start": {
        bg: "bg_room_night.webp",
        ...
        choices: [
            { text: "(Задохнуться от ужаса) Не может быть...", next: "ch3_serezha_returns" }
        ]
    },
    // ВЕТКА 2: Жанна не стала читать, но Серёжа сам замечает
    "ch3_trust_path": {
        bg: "bg_room_night.webp",
        spriteLeft: "", spriteCenter: "zhanna_norm.webp", spriteRight: "",
        speaker: "Жанна",
        text: "(Мысли) Нет. Я не буду проверять его телефон. Я не уподоблюсь им. Я доверяю Серёже.",
        choices: [
            { text: "[Далее]", next: "ch3_serezha_returns" }
        ]
    },
    ...
    "ch3_serezha_returns": {
        ...
        speaker: "Серёжа",
        text: "Фух, вода немного привела в чувства... Жанна, ты плачешь? Что случилось?",
        choices: [
            { text: "Серёжа... Тебе пришло сообщение. Про ключи. От скрытого номера.", next: "ch3_serezha_shocked" }
        ]
    },
    "ch3_serezha_shocked": {
        bg: "bg_room_night.webp",
        spriteLeft: "serezha_shocked.webp", spriteCenter: "", spriteRight: "zhanna_cry.webp",
        speaker: "Серёжа",
        text: "Какое сообщение? О чем ты говоришь? Дай сюда телефон.",
        choices: [
            { text: "[Смотреть, как он читает]", next: "ch3_the_truth_revealed" }
        ]
    },
    "ch3_the_truth_revealed": {
        bg: "bg_room_night.webp",
        spriteLeft: "serezha_angry.webp", /* Можно использовать norm, если нет angry */
        spriteCenter: "", spriteRight: "zhanna_cry.webp",
        speaker: "Серёжа",
        text: "Что за бред?! Это же обычная SMS-подмена. Посмотри в детализацию номера — это сервис для анонимных рассылок. Кто-то специально шлет этот мусор!",
        choices: [
            { text: "Но Рома... Рома показывал мне фото, где ты заходишь в подъезд Ани!", next: "ch3_the_photo_lie" }
        ]
    },
    "ch3_the_photo_lie": {
        bg: "bg_room_night.webp",
        spriteLeft: "serezha_shocked.webp", spriteCenter: "", spriteRight: "zhanna_cry.webp",
        speaker: "Серёжа",
        text: "В подъезд Ани?! Жанна, я не был там с момента нашего расставания! А знаешь, где я был сегодня вечером, когда был «недоступен»?",
        choices: [
            { text: "Где?...", next: "ch3_the_box" }
        ]
    },
    "ch3_the_box": {
        bg: "bg_room_night.webp",
        spriteLeft: "serezha_smile.webp", spriteCenter: "", spriteRight: "zhanna_scared.webp",
        speaker: "Серёжа",
        text: "(Достает из кармана куртки маленькую бархатную коробочку) Я был в подвальной мастерской у ювелира. Там глушилки стоят, связи вообще нет. Я хотел забрать это к нашей годовщине.",
        choices: [
            { text: "Серёжа... это...", next: "ch3_the_gift" }
        ]
    },
    "ch3_the_gift": {
        bg: "bg_room_night.webp",
        spriteLeft: "serezha_smile.webp", spriteCenter: "", spriteRight: "zhanna_cry.webp",
        speaker: "Серёжа",
        text: "Они пытаются сломать тебя. Аня не может смириться с тем, что я счастлив с тобой. А Рома думает, что если разрушит нас, ты прибежишь к нему. Они больные, Жанна.",
        choices: [
            { text: "Я так испугалась... Я думала, что теряю тебя.", next: "ch3_embrace" },
            { text: "Прости меня. Прости, что на секунду усомнилась.", next: "ch3_embrace" }
        ]
    },
    "ch3_embrace": {
        bg: "bg_room_night.webp",
        spriteLeft: "serezha_smile.webp", spriteCenter: "", spriteRight: "zhanna_smile.webp",
        speaker: "Серёжа",
        text: "(Крепко обнимает) Тебе не за что извиняться. Ты ни в чем не виновата. Я люблю тебя, слышишь? Только тебя. И я никому не позволю разрушить нашу семью.",
        choices: [
            { text: "Я тоже тебя люблю. Больше всего на свете.", next: "ch3_united" }
        ]
    },
    "ch3_united": {
        bg: "bg_room_night.webp",
        ...
        speaker: "Жанна",
        text: "(Вытирая слезы, голос становится твердым) Они думали, что сделают меня слабой. Но они ошиблись. Если Аня и Рома хотят войны — они её получат.",
        choices: [
            { text: "Мы справимся с этим вместе.", next: "chapter_3_end" }
        ]
    },
    "chapter_3_end": {
        bg: "bg_room_night.webp",
        ...
        speaker: "Система",
        text: "ГЛАВА 3 ЗАВЕРШЕНА. Иллюзии разрушены. Доверие восстановлено. Теперь охотники станут жертвами...",
        choices: [
            { text: "[Конец Демоверсии]", next: "start" }
        ]
    }
};
